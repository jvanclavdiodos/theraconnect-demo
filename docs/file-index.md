...
| `public/js/avatar-cropper.js`, `resources/views/partials/avatar-cropper.blade.php` | shared patient/staff avatar selection, square crop, zoom/rotation, compression, and guarded form submission |
