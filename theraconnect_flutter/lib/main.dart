...
class _TheraConnectAppState extends ConsumerState<TheraConnectApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp.router(
      ...
      // ThemeMode.system follows the device's prefers-color-scheme setting,
      // matching the web dashboard's `[data-bs-theme]` behavior out of the
      // box. A user-toggle in the profile/settings screen can override this
      // later by switching themeModeProvider between light/dark.
